...
This artifact is the context map. The detailed comparison invariant lives in the [comparison evidence contract](comparison-evidence-contract.md).
...
- Aggregate, values, and adapters: [`src/lib.rs`](../../src/lib.rs)
